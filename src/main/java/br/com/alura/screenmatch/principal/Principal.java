...
public class Principal {
    ...
    private final String API_KEY = "&apikey=37b170a";
...
//        List<String> nomes = Arrays.asList("Felipe", "Fausto", "Erika", "Pedro", "Arthur");
//
//        nomes.stream().sorted().limit(3).filter(n -> n.startsWith("F")).map(n -> n.toUpperCase())
